...
public enum SonarMigrationPlan: SchemaMigrationPlan {
    public static var schemas: [any VersionedSchema.Type] {
        [SonarSchemaV1.self, SonarSchemaV2.self]
    }
...
public typealias Playlist = SonarSchemaV2.Playlist
public typealias PlaylistItem = SonarSchemaV2.PlaylistItem
public typealias TrackRecord = SonarSchemaV2.TrackRecord

public enum SonarModelContainer {
    public static func make(inMemory: Bool = false, url: URL? = nil) throws -> ModelContainer {
        let schema = Schema(versionedSchema: SonarSchemaV2.self)
